...
void loop(void)
{
  ...
  Serial.print('q'); //q for line of quaternion logs
  Serial.print(w_);  Serial.print(',');
  Serial.print(x_);  Serial.print(',');
  Serial.print(y_);  Serial.print(',');
  Serial.print(z_);  Serial.println();
